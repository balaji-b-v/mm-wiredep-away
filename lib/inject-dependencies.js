    ...
    dependencies.
      ...
      forEach(function (filePath) {
        if (typeof fileType.replace[blockType] === 'function') {
          ...
          newFileContents += spacing + fileType.replace[blockType].replace('{{filePath}}', filePath.replace("../node_modules/angular-translate/dist/angular-translate.js", "../bower_components/angular-translate/angular-translate.js"));
        }
        if (quoteMark) {
